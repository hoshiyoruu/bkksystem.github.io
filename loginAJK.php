            ...
            <div class="row justify-content-center">
              <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <div class="card-body">
                    ...
                    <form id="login" name="login" method="post" action="plogin.php">
                      ...
                      <div class="tab-content pt-2" id="myTabjustifiedContent">
                        <div class="tab-pane fade show active" id="AJK-justified" role="tabpanel" aria-labelledby="AJK-tab">
                          <div class="col-12">
                          ...
                          <br>
                          <div class="col-12">
                            <button class="btn btn-success w-100" name="ahliLogin" type="ahliLogin"><a href="loginAhli.php" style="color: white">Ahli BKK</a></button>
                          </div>
                        </div>
                      </div>
                    </form>
                ...
                <div class="credits">
                  ...
                  <center>Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a></center>
                </div>
